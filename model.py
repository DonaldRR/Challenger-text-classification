...
# 		feature_20 = LSTM(64)(a)
		...
		feature_31 = Dense(32, activation='relu')(feature_21)
		feature_32 = Dense(32, activation='relu')(feature_22)
		feature_33 = Dense(32, activation='relu')(feature_23)
		feature_34 = Dense(32, activation='relu')(feature_24)
		feature_35 = Dense(32, activation='relu')(feature_25)
		feature_36 = Dense(32, activation='relu')(feature_26)
		feature_37 = Dense(32, activation='relu')(feature_27)
		feature_38 = Dense(32, activation='relu')(feature_28)
		feature_39 = Dense(32, activation='relu')(feature_29)
		feature_310 = Dense(32, activation='relu')(feature_210)
		feature_311 = Dense(32, activation='relu')(feature_211)
		feature_312 = Dense(32, activation='relu')(feature_212)
		feature_313 = Dense(32, activation='relu')(feature_213)
		feature_314 = Dense(32, activation='relu')(feature_214)
		feature_315 = Dense(32, activation='relu')(feature_215)
		feature_316 = Dense(32, activation='relu')(feature_216)
		feature_317 = Dense(32, activation='relu')(feature_217)
		feature_318 = Dense(32, activation='relu')(feature_218)
		feature_319 = Dense(32, activation='relu')(feature_219)
		feature_320 = Dense(32, activation='relu')(feature_220)
